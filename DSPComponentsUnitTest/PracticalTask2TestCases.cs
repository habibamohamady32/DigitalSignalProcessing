...
namespace DSPComponentsUnitTest
{
    ...
    public class PracticalTask2TestCases
    {
        ...
        public void PracticalTask2TestCaseECG()
        {
            ...
            T2_Obj.SignalPath = "C:/Users/Habiba Mohamady/source/repos/DigitalSignalProcessing/DSPComponentsUnitTest/TestingSignals/ecg400.ds";
            T2_Obj.miniF = 150;
            T2_Obj.maxF = 250;
            T2_Obj.Fs = 1000;
            T2_Obj.newFs = 500;
            ...
            var expectedOutput = UnitTestUtitlities.LoadSignal("C:/Users/Habiba Mohamady/source/repos/DigitalSignalProcessing/DSPComponentsUnitTest/TestingSignals/FileDown.ds");
